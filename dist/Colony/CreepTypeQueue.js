...
var CreepTypeQueue = /** @class */ (function () {
    ...
    CreepTypeQueue.prototype.CreateStack = function (tracker) {
        ...
        var list = __spreadArray(__spreadArray(__spreadArray(__spreadArray([], this.CreateList(CreepBehaviorConsts_1.HARVEST_BEHAVIOR, cur_harvester, max_harvest)), this.CreateList(CreepBehaviorConsts_1.UPGRADER_BEHAVIOR, cur_upgrader, max_upgrader)), this.CreateList(CreepBehaviorConsts_1.BUILDER_BEHAVIOR, cur_builder, max_builder)), this.CreateList(CreepBehaviorConsts_1.DEFENDER_BEHAVIOR, cur_defenders, max_defender));
