...
export class CreepTypeQueue {
    ...
    constructor(room: RoomWrapper) {
        ...
        this.m_Max_types.set(REPAIR_BEHAVIOR, (num_of_structs > 0) ? 1 : 0)
    }
    ...
    CreateStack(tracker: CreepTypeTracker): Stack<number> {
        ...
        const cur_repair = tracker.GetTypeCount(REPAIR_BEHAVIOR)
        ...
        const max_repair = this.m_Max_types.get(REPAIR_BEHAVIOR)!!
        ...
        const list = [
            ...
            ...this.CreateList(REPAIR_BEHAVIOR, cur_repair, max_repair),
